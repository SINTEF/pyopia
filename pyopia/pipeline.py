...
class Pipeline():
    ...
    def __init__(self, steps):
        ...
        print('  Running', self.steps['common'])
        self.common = self.steps['common'](self.common)
    ...
    def run(self):
        ...
        self.common['steps_string'] = steps_to_string(self.steps)
        ...
        for s in self.steps:
            ...
            print('calling: ', str(type(self.steps[s])), ' with: ', list(self.common.keys()))
