...
@pytest.mark.slow
def test_match_to_database(classifier_training_database, example_model_path):
    """
    ...
    """
    database_path = classifier_training_database

    # Load the trained tensorflow model and class names
    cl = pyopia.classify.Classify(model_path=example_model_path)
...
@pytest.mark.slow
def test_pipeline_classification(classifier_training_database, example_model_path):
